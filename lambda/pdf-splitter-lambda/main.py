...
def lambda_handler(event, context):
    ...
    try:
        ...
        chunks = split_pdf_into_pages(pdf_file_content, pdf_file_key, s3, bucket_name, 200) # Original was 200, 10 still failed with `SLIDE4L.pdf`, 5 also did not work, 2 was too small?
